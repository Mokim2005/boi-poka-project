...
const Book = ({ book }) => {
  return (
    <Link to={`/bookDetails/${book.bookId}`}>
      ...
      >
        <figure className="p-3 bg-white/10 w-2/3 mx-auto rounded-xl">
          <motion.img 
        ...
        <div className="card-body text-white">
          ...
          <div className="card-actions justify-center flex-wrap gap-2">
            <div className="badge badge-outline text-white border-white/30 bg-white/10">
              {book.category}
            </div>
            <div className="badge badge-outline text-white border-white/30 bg-white/10 flex items-center gap-1">
              {book.rating}
